...
# Generated on 2025-06-14T03:30:05.588Z
...
X, y = make_classification(
    ...
    random_state=926  # Random seed for reproducibility
)
...
clf = DecisionTreeClassifier(max_depth=5)  # Random max_depth between 3 and 7
